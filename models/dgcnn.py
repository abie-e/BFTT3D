...
class DGCNN(nn.Module):
    ...
    def __init__(self, dataset='modelnet40_c'):
        super().__init__()
        ...
        class Args:
            def __init__(self):
                ...
                self.leaky_relu = 1
        args = Args()
        self.model = DGCNN_original(args, output_channels=num_class)
...
class DGCNN_original(nn.Module):
    def __init__(self, args, output_channels=40):
        super(DGCNN_original, self).__init__()
        self.args = args
        self.k = args.k
