...
For experiments on corrupted ModelNet data, the ModelNet40-C dataset can be downloaded here (https://github.com/jiachens/ModelNet40-C).The download link for experiments with [ScanObjectNN-C](https://drive.google.com/file/d/1PpS4oPoPA03-RWTiVp-huvhqa7jh3PbW/view?usp=sharing) is also provided.
